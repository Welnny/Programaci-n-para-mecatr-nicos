...
void Lectura(float [][MES][ANIO], int, int, int);
void Funcion1(float [][MES][ANIO], int, int, int);
void Funcion2(float [][MES][ANIO], int, int, int);
void Funcion3(float [][MES][ANIO], int, int, int);
