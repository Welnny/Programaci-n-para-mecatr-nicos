...
/* La función Simétrico se utiliza para determinar si el arreglo bidimensional cuadrado es simétrico. Si es simétrico regresa 1, en caso contrario, 0. Observa que en el segundo ciclo solamente se recorre la matriz triangular inferior, sin la diagonal principal. */
{
int I = 0, J, F = 1;
while ((I < T) && F)
{
