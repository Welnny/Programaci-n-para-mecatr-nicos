...
int main(void)
{
    ...
    struct alumno a6; /* Observa que a6 es una variable de tipo estructura alumno. */
    ...
    free(a4); /* Liberar la memoria asignada a a4 */
    free(a5); /* Liberar la memoria asignada a a5 */
