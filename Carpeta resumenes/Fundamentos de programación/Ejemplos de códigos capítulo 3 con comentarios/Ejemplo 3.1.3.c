...
/*"While" se ejecutará siempre y cuando se ingrese pagos diferentes a 0, al momento en el que se ingrese un valor de pago igual a 0
"while se detendrá y se mostrará la suma total de todos los pagos.*/
