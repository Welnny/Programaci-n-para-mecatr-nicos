...
const int MAX = 10;              /* Usamos #define para definir una constante */
...
void main(void)
{
    ...
    Lectura(VE1, MAX);
    /* Se llama a la función Lectura. Observa que el paso del arreglo a la función es por referencia. Sólo se debe incluir el nombre del arreglo. */
    Lectura(VE2, MAX);
