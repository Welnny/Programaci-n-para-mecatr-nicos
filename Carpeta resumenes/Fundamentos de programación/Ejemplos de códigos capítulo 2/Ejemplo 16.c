...
/* Empresa textil.
El programa, al recibir datos como decisivos la categoría y antigüedad de un empleado, determina si el mismo reúne las condiciones establecidaas por la empresa para ocupar un nuevo cargo en una sucursal.
