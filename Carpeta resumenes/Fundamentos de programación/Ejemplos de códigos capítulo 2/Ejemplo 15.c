...
/*Spa.
El programa, al recibir datos como el tipo de tratamiento, la edad el número de dias de internación del cliente en el spa, calcula el costo total del tratamiento.
...
void main(void)
{
    int TRA, EDA, DIA;
    float COS;
    printf("Ingrese el tipo de tratamiento, edad y días:");
