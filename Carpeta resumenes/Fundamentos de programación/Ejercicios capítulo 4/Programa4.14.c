...
int RA4 = 0;
int RA5 = 0;
/* El uso de variable globales no es muy recomendable. En estos problemas se utilizan unicamente con el objetivo de que el lector pueda observar la forma en que se aplican.*/

void main(void)
{
    float CAL;
    printf("Ingrese la primera calificaicon del alumno:");
    scanf("&f", &CAL);
    while (CAL != -1)
{
